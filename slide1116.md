...
---
## 実機動作動画（前方カメラ）
[![Watch the video1](https://img.youtube.com/vi/xeJfs4FgBNw/maxresdefault.jpg)](https://youtu.be/xeJfs4FgBNw)
...
- モデルを inventor & blender で作成，gazeboに反映
    ...
    - [](https://github.com/RobotDesign3-Team5/eraser_model)
    - [](https://github.com/RobotDesign3-Team5/battery_model)
    - [](https://github.com/RobotDesign3-Team5/GlueStick_model)
