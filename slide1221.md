...
座標の中心を画像の中心にし,ハンコが右上、右下、左上、左下のどこにあるかを検出してハンコの上まで移動していく。
[](ここに動画を入れる)

問題点、改善点
2次元で画像を考えていてcrane_x7が動くことでカメラの角度が変わり座標がずれてしまった.今回は掴みにいく条件を広く設定することで対処した。realsenseの機能を最大限活かしきれなかった.
